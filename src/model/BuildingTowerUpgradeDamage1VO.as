package model
{
	...
	public class BuildingTowerUpgradeDamage1VO extends EntityVO implements IBuyableEntity, ITargeter, IUnitSpawner, ITargeteable, IBuildeable
	{
		...
		public function BuildingTowerUpgradeDamage1VO(x:int = 0, y:int = 0)
		{
			...
			_cost = 2;
			type = "buildingTowerUpgradeDamage1";
			speed = 0;
			skinClass = new SkinClass("building_tower_upgrade_damage_1", "building_tower_upgrade_damage_1", false);
			skinClass.animationsDic["building_tower_upgrade_damage_1"] = true;
